...
df_2003_2024 = df_2002_2024.dropna().copy()
df_2003_2024[['Totale maschi -1','Totale femmine -1','Totale -1']] = df_2003_2024[['Totale maschi -1','Totale femmine -1','Totale -1']].astype(int)
...
# %%
df_2025_2040.to_csv('../previsioni/Test4_Previsione_Popolazione_2025-2040.csv', index=False)
print(df_2025_2040)
# %%
df_totali = df_2003_2024.groupby('Anno', as_index=False)['Totale'].sum()
